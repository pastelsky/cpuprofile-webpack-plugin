...
function writeProfileFiles(profilePath, options) {
  function onProfileDone(profilePath) {
    const profile = readFileSync('build/profile-results/profile', "utf-8");
    ...
    writeFileSync('build/profile-results/results' + ".html", htmlResult);
    console.log(
  ...
  cpuProfiler('build/profile-results/cpu.profile', Object.assign({}, options, { onProfileDone }));
}
